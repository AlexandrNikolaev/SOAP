...
class SoapCurlXML
{
    public $dataFromTheForm = '2017-09-27';//$_POST['fieldName'];  request data from the form
    public $soapUrl;
    ...
    xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
      <soap:Body>
        <GetCursOnDateXML xmlns="http://web.cbr.ru/">
          <On_date>' . $this->dataFromTheForm . '</On_date>
        </GetCursOnDateXML>
      </soap:Body>
...
// user $parser to get your data out of XML response and to display it.
        $obj = $parser->GetCursOnDateXMLResponse->GetCursOnDateXMLResult->ValuteData->ValuteCursOnDate;
